...
class HospitalController extends Controller
{
    ...
    public function validPopup(Request $request)
    {
        ...
        $click_type = $request->get('click_type');
        return $this->service->validPopup($tag_id, $click_type);
    }
    ...
    public function popupClicked(Request $request)
    {
        ...
        // return $tag_id;
        return $this->service->popupClicked($tag_id, $click_type, $type);
    }

    public function getHosName(Request $request)
    {
        $tag_id = $request->get('tag_id');
        return $this->service->getHosName($tag_id);
    }

    public function closeAllBanner(Request $request)
    {
        if (!$request->get('state')) return  $this->service->getCloseAllBannerState();
        $state = $request->get('state');
        return $this->service->closeAllBanner($state);
    }
}
