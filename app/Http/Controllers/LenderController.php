...
class LenderController extends Controller
{
    ...
    public function index(Request $request): object
    {
        ...
        return $this->service->fetchAdmin($keyword, $sortKey, $orderBy);
    }
    ...
    {
        Log::info("Save subAdmin Data", [$request]);
        ...
        // DB::transaction(function () use ($userRequest, $lenderRequest) {
        //     // 貸船業者.船新規登録
        ...
        $this->service->storeAdmin($userRequest);
    ...
    public function show($id): object
    {
        ...
        return $this->service->fetchAdminDetail($id);
    }
    ...
    {       
        ...
        $this->service->update($userRequest, $id);
    ...
    {
        return $this->service->deleteLender($id);
    }
}
