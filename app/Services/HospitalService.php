...
class HospitalService
{
    ...
    {
        return $this->repository->validPopup($tag_id, $click_type);
        // return "bb";
    }
    
    public function popupClicked($tag_id, $click_type, $type)
    {
        return $this->repository->popupClicked($tag_id, $click_type, $type);
    }

    public function getHosName($tag_id)
    {
        return $this->repository->getHosName($tag_id);
    }

    public function closeAllBanner($state)
    {
        return $this->repository->closeAllBanner($state);
    }

    public function getCloseAllBannerState()
    {
        return $this->repository->getCloseAllBannerState();
    }
}
